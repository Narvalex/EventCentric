...
namespace EventCentric.EventSourcing
{
    public interface IEventStore
    {
        ...
        SerializedEvent[] FindEventsForConsumer(long from, long to, int quantity, string consumer);

        SerializedEvent[] FindEventsForConsumer(long from, long to, Guid streamId, int quantity, string consumer);
    }
